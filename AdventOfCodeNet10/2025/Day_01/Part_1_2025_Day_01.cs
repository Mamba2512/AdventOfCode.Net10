...
internal class Part_1_2025_Day_01 : Days
  {
    ...
    */
    ...
    public override string Execute()
    {
      ...
      { 
        Debug.WriteLine($"Moving from {nextPos} with {move.Direction}{move.Distance}");
        nextPos = TraverseLockPath(nextPos, move);
        Debug.WriteLine($"  --> New Position: {nextPos}");
        if (nextPos == 0)
        {
          totalCount++;
        }
    ...
    public int TraverseLockPath(int pos, Move nextMove)
    {
