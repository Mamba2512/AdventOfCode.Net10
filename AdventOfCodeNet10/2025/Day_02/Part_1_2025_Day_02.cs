...
namespace AdventOfCodeNet10._2025.Day_02
{
  internal class Part_1_2025_Day_02 : Days
  {
    ...
    */
    ...
    public override string Execute()
    {
      ...
      foreach (var line in Lines)
      {
        ...
        foreach (var idRange in splittedIDRanges)
        {
          ...
          totalCount = totalCount + GetInvalidIDsInRange((startID, endID)).Sum();
        }
      }
    ...
    public List<long> GetInvalidIDsInRange(IdRange idRange)
    {
      ...
      for (long id = idRange.Start; id <= idRange.End; id++)
      {
        ...
        var secondHalf = idString.Substring(length / 2, length / 2);
